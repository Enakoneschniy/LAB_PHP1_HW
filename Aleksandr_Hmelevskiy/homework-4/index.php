        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="form col-md-4 col-md-offset-1 col-lg-4 col-lg-offset-1">
                    <h3>Задача №7</h3>
                    <form action="/" method="post">
                        <input type="text" class="form-control" name="some_city" placeholder="Введите какой-то город">
                        <input type="submit" class="btn btn-primary btn-block" name="submit" value="Подтвердить">
                    </form>

                    <?php
                    $some_city = ($_POST['some_city']);
                    $arrCities = ['Киев','Харьков','Полтава','Львов'];
                    if (isset($_POST['submit'])) {
                        foreach ($arrCities as $arrCity){
                            while ($some_city == $arrCity){
                                echo "<p class='text-success'>Ваш город совпал ($some_city)</p>";
                                break;
                            }
                        }
                    }
